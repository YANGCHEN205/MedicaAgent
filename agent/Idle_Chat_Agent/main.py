...
import json
from agent.Idle_Chat_Agent.prompt import gen_prompt, user_prompt,tools_map, query_user_for_details
...
class Idle_Chat_Agent(object):
    ...
    def agent_execute(self, query, max_request_time=5, debug=False):
        ...
        while cur_request_time < max_request_time:
            ...
            if debug:
                print(f'-------------智能闲聊Agent第{cur_request_time}次推断------------')
