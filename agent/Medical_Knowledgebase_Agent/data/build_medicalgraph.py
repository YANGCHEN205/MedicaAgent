...
class MedicalGraph:
    def __init__(self):
        ...
        self.data_path = os.path.join(cur_dir, '/root/autodl-tmp/MedicaAgent/agent/chatbotagent/data/medical.json')
    ...
    def create_node(self, label, nodes):
        count = 0
        for node_name in tqdm.tqdm(nodes):
    ...
    def create_diseases_nodes(self, disease_infos):
        count = 0
        for disease_dict in tqdm.tqdm(disease_infos):
    ...
    def create_relationship(self, start_node, end_node, edges, rel_type, rel_name):
        ...
        for edge in tqdm.tqdm(set(set_edges)):
            edge = edge.split('###')
            p = edge[0]
            q = edge[1]
